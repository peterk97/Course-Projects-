...
/**
 * This is going to be a jar file without a main method to be able to use it in other projects
 * the purpose of this to se how to create these jar files and also learn about packages
 * this is a module what we are in and you can have more than just one in the same project
 */
